package com.spmods.spgram.presentation.settings.chatSettings
...
import com.spmods.spgram.presentation.core.util.EmojiStyle
...
class DefaultChatSettingsComponent(
    ...
    private fun downloadEmojiPack(style: EmojiStyle) {
        val url = when (style) {
            EmojiStyle.APPLE -> "https://github.com/spgram-android/emojies/releases/download/1.0/apple.ttf"
            EmojiStyle.TWITTER -> "https://github.com/spgram-android/emojies/releases/download/1.0/twemoji.ttf"
            EmojiStyle.WINDOWS -> "https://github.com/spgram-android/emojies/releases/download/1.0/win11.ttf"
            EmojiStyle.CATMOJI -> "https://github.com/spgram-android/emojies/releases/download/1.0/catmoji.ttf"
            EmojiStyle.NOTO -> "https://github.com/spgram-android/emojies/releases/download/1.0/notoemoji.ttf"
            else -> return
        }
        val fileName = when (style) {
            EmojiStyle.APPLE -> "apple.ttf"
