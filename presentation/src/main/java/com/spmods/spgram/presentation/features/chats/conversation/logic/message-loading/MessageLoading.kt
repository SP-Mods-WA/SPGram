...
import com.spmods.spgram.presentation.features.chats.conversation.ChatScrollCommand
import com.spmods.spgram.presentation.features.chats.conversation.DefaultChatComponent
import com.spmods.spgram.presentation.features.chats.conversation.ScrollAlign
import java.io.File
...
internal fun DefaultChatComponent.requestMessageHighlight(messageId: Long) {
    _state.update { currentState ->
        ...
        currentState.copy(
            highlightRequest = com.spmods.spgram.presentation.features.chats.conversation.MessageHighlightRequest(
                messageId = messageId,
                token = nextToken
            ),
