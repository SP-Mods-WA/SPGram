...
import com.spmods.spgram.presentation.features.viewers.YouTubeViewer
import com.spmods.spgram.presentation.features.webapp.MiniAppViewer
import com.spmods.spgram.presentation.features.webapp.components.InvoiceDialog
import com.spmods.spgram.presentation.features.webapp.components.MiniAppTOSBottomSheet
...
@Composable
internal fun MiniAppOverlay(state: ChatComponent.State, component: ChatComponent) {
    AnimatedVisibility(
...
@Composable
internal fun WebViewOverlay(state: ChatComponent.State, component: ChatComponent) {
    AnimatedVisibility(
...
@Composable
internal fun InvoiceOverlay(state: ChatComponent.State, component: ChatComponent) {
...
@Composable
internal fun MiniAppTOSOverlay(state: ChatComponent.State, component: ChatComponent) {
