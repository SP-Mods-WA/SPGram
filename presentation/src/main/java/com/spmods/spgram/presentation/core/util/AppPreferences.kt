...
import com.spmods.spgram.domain.repository.DEFAULT_SMART_SWITCH_CHECK_INTERVAL_MINUTES
import com.spmods.spgram.domain.repository.MAX_SMART_SWITCH_CHECK_INTERVAL_MINUTES
import com.spmods.spgram.domain.repository.MIN_SMART_SWITCH_CHECK_INTERVAL_MINUTES
...
class AppPreferences(
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("spgram_prefs", Context.MODE_PRIVATE)
