...
object SpgramMigrations {
    ...
    val MIGRATION_32_33 = object : Migration(32, 33) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.addColumn("messages", "replyToStoryPosterChatId", "INTEGER NOT NULL DEFAULT 0")
            db.addColumn("messages", "replyToStoryId", "INTEGER NOT NULL DEFAULT 0")
        }
    }

    val MIGRATION_33_34 = object : Migration(33, 34) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.addColumn("chats", "lastMessageIsStoryReply", "INTEGER NOT NULL DEFAULT 0")
        }
    }
    ...
    val MIGRATION_35_36 = object : Migration(35, 36) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.addColumn("chats", "isLastMessageDeleted", "INTEGER NOT NULL DEFAULT 0")
        }
    }
