...
import com.spmods.spgram.domain.models.MessageDeletedEvent
...
import com.spmods.spgram.domain.models.MessageIdUpdatedEvent
import com.spmods.spgram.domain.models.MessageModel
import com.spmods.spgram.domain.models.MessageSendOptions
import com.spmods.spgram.domain.models.MessageUploadProgressEvent
...
import com.spmods.spgram.domain.repository.ReadUpdate
...
class TdMessageRemoteDataSource(
    ...
    override suspend fun searchCallHistory(fromMessageId: Long, limit: Int): TdApi.FoundMessages? {
        val request = TdApi.SearchMessages().apply {
            ...
            this.offset = ""
            this.limit = limit
            this.filter = TdApi.SearchMessagesFilterEmpty()
        }
        return safeExecute(request)
    }
