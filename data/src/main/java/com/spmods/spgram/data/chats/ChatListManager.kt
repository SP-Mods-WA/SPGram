...
class ChatListManager(
    ...
    fun rebuildChatList(
        ...
        mapChat: (TdApi.Chat, Long, Boolean) -> com.spmods.spgram.domain.models.ChatModel?
    ): List<com.spmods.spgram.domain.models.ChatModel> {
        ...
        fun mapEntry(chatId: Long, position: TdApi.ChatPosition): com.spmods.spgram.domain.models.ChatModel? {
        ...
        val result = ArrayList<com.spmods.spgram.domain.models.ChatModel>()
        var pinnedMapped = 0
